...
struct L10n {
    ...
    static let strings: [String: [String: String]] = [
        "zh-Hans": [
            ...
            "verifyChecksum": "传输完成后校验完整性",
            "verifyChecksumHint": "强一致性校验（耗时较长），若发现数据损坏将立即触发系统通知提醒。",
            "sortFormats": "EXIF 智能分类",
            "sortFormatsHint": "重命名并组织照片/视频的目录层级结构。例如自动整理为：2023/10/24/",
            "dirTemplate": "目录命名模板",
            ...
            "fileFilters": "格式过滤",
            "checksumType": "校验算法",
            "checksumRsync": "Rsync 默认 (增量)",
            "checksumMD5": "MD5 (强力校验)",
            "checksumSHA256": "SHA256 (安全级校验)",
            ...
            "autoStartDisabled": "此功能正在开发中，敬请期待",
            "openLogFolder": "打开日志",
            "logMenu": "运行日志",
            "lang": "界面语言",
        ...
        "en": [
            ...
            "verifyChecksum": "Verify Integrity After Transfer",
            "verifyChecksumHint": "Byte-to-byte validation. System notification will trigger if corruption detected.",
            "sortFormats": "EXIF Smart Sorting",
            "sortFormatsHint": "Organize into folders like: 2023/10/24/",
            ...
            "checksumRsync": "Rsync Default (Delta Check)",
            "checksumMD5": "MD5 (Strong)",
            "checksumSHA256": "SHA256 (Secure)",
            ...
            "autoStartDisabled": "This feature is under development, coming soon",
            ...
            "resetBtn": "Restore Default Settings (Restart Needed)",
