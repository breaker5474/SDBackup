...
struct L10n {
    ...
    static let strings: [String: [String: String]] = [
        "zh-Hans": [
            ...
            "verifMD5": "MD5 强力校验 (逐字节比对)",
            "verifSHA256": "SHA256 安全级校验 (极其耗时)",
            "enableVerification": "开启传输完成后静默校验 (防数据损坏)",
        ...
        "en": [
            ...
            "verifMD5": "MD5 Strong (Byte-to-byte)",
            "verifSHA256": "SHA256 Secure (Extremely slow)",
            "enableVerification": "Enable quiet verification after transfer",
